...
class CustomButton
{
    ...
    /**
     * Признак того, что эемент будет представлен кнопкой. Если значение равно false, то элемент будет представлен разделителем.
    ...
    /**
     * Контент, который будет добавлен в блок разделителя. Данное свойство используется если свойство isButton = false.
